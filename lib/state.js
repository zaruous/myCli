...
// 사용자가 읽기를 승인한 BASE_DIR 밖 절대경로 (세션 한정, 읽기 전용)
export const approvedOutsideReads = new Set();

// 표시 접기/펴기 상태 (세션 한정) — /thinking, /skills 로 전환
//  thinking: 도구 호출 입력·결과 등 중간 과정 표시
//  skills:   스킬 로드 시 주입되는 프롬프트 전문 표시
export const displayState = { thinking: false, skills: false };
